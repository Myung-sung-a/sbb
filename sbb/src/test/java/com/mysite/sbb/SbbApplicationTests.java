...
class SbbApplicationTests {
	...
	@Autowired		// 객체 자동 주입 , JPA의 CRUD 할 수 있는 메소드가 적용되어 있음.
	...
	private QuestionService questionService;
	   ...
	   public void insertAnswer() {
	      ...
	      // Question 객체 질문에 대한 값을 가지고와서 answer question 필드에 넣어준다.
	      Optional<Question> op =
	    		  this.questionRepository.findById(2);
	      q = op.get();
	      
	      
	      a.setContent("2 글에 대한 답변 입니다. - 2 ");
	...
	*/
	...
	public void testjpa8() {
		...
		// 2.끄집어 낸 객체의 q.getAnswerList();		<== 끄집어 낸 객체의 답변글을 얻어온다.
	...
	*/
	...
	public void testjpa7() {
		...
		if (op.isPresent()) { 	// isPresent(); null (false) , NotNull (true)
			Answer a = op.get();
			System.out.println(a.getId());
			System.out.println(a.getContent());
			System.out.println(a.getCreateDate());
	...
	*/
	...
	public void testjpa3() {
		...
		System.out.println("=====DESC : 내림 차순 정렬=========================");
	...
	*/
	...
	/* 조건에 맞는 레코드 하나만 가져오기 : PK 컬럼은 findById(1)
	...
	public void jpaTest() {
		...
		//assertEquals(10, all.size());	// assertEquals(기대값, 실제값) , 성공(두 값이 일치)
		
		Question q = all.get(3); 	// List all 변수에 담긴 0번방의 Question 객체를 끄집어
